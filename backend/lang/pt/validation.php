...
return [
    ...
    */
    ...
    'custom' => [
        // CPF validation
        'cpf' => [
            'valid' => 'O :attribute deve ser um CPF válido.',
        ],

        // Product validation messages
        'name' => [
            'max' => 'O :attribute não pode exceder 255 caracteres.',
        ],
        'price' => [
            'numeric' => 'O :attribute deve ser um número válido.',
            'min' => 'O :attribute não pode ser negativo.',
            'max' => 'O :attribute não pode exceder 999.999,99.',
        ],
        'stock_quantity' => [
            'integer' => 'A :attribute deve ser um número inteiro.',
            'min' => 'A :attribute não pode ser negativa.',
        ],
        'image' => [
            'image' => 'O arquivo enviado deve ser uma imagem.',
            'mimes' => 'A :attribute deve ser um arquivo do tipo: :values.',
            'max' => 'O tamanho da :attribute não pode exceder 2MB.',
        ],

        // Customer validation messages
        'email' => [
            'email' => 'Por favor, forneça um endereço de :attribute válido.',
            'unique' => 'Este endereço de :attribute já está cadastrado.',
            'max' => 'O endereço de :attribute não pode exceder 255 caracteres.',
        ],
        ...
        'discount_percentage' => [
            'numeric' => 'O :attribute deve ser um número válido.',
            'min' => 'O :attribute não pode ser negativo.',
            'max' => 'O :attribute não pode exceder 100%.',
        ],
        'items' => [
            'required' => 'Pelo menos um item é obrigatório.',
            'array' => 'Os itens devem ser um array.',
            'min' => 'Pelo menos um item é obrigatório.',
        ],
        'items.*.product_id' => [
        ...
        'status' => [
            'enum' => 'Status inválido. Deve ser um dos seguintes: pending, completed, cancelled.',
        ],

        // Business logic validation messages
        'insufficient_stock' => 'Estoque insuficiente. Apenas :available disponível para :product.',
        'invalid_status_transition' => 'Não é possível alterar status de :from para :to.',
    ],
